...
const en = {
  ...
  "launches.viewNew": "New",
  "launches.viewTrending": "Trending",
  "launches.opened": "Under $10M · {floor}+ · newest first",
  "launches.live": "Under $10M · {floor}+ · coil ranked",
  "launches.mcapShort": "MCAP",
  "launches.gradeAll": "Any",
  "launches.dexscreener": "DEX Screener",
  "launches.snipe": "Snyper · buy {symbol}",
  "launches.noChart": "Not enough trades to draw yet.",
  "launches.gradeDeep": "Deep",
  "launches.bandAll": "All",
  "launches.bandCoil": "Coiling",
  "launches.bandPump": "Pumping",
  "launches.bandDump": "Dumping",
  "launches.showing": "{shown} of {total}",
  "launches.noMatch": "Nothing here matches that.",
  "launches.noMatchHint":
  ...
  "launches.clear": "Clear the filters",
  "launches.fresh": "NEW",
  "launches.pair": "Pair",
  ...
  "launches.empty": "Nothing has traded or opened recently.",
  "launches.emptyHint":
...
const id: Record<TKey, string> = {
  ...
  "launches.viewNew": "Baru",
  "launches.viewTrending": "Ramai",
  "launches.opened": "Di bawah $10J · {floor}+ · terbaru dulu",
  "launches.live": "Di bawah $10J · {floor}+ · urut coil",
  "launches.mcapShort": "MCAP",
  "launches.gradeAll": "Semua",
  "launches.dexscreener": "DEX Screener",
  "launches.snipe": "Snyper · beli {symbol}",
  "launches.noChart": "Belum cukup transaksi untuk digambar.",
  "launches.gradeDeep": "Dalam",
  "launches.bandAll": "Semua",
  "launches.bandCoil": "Coiling",
  "launches.bandPump": "Naik",
  "launches.bandDump": "Jatuh",
  "launches.showing": "{shown} dari {total}",
  "launches.noMatch": "Tidak ada yang cocok dengan itu.",
  "launches.noMatchHint":
  ...
  "launches.clear": "Bersihkan saringan",
  "launches.fresh": "BARU",
  "launches.pair": "Pair",
  ...
  "launches.empty": "Belum ada yang jalan atau dibuka belakangan ini.",
  "launches.emptyHint":

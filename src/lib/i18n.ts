...
const en = {
  ...
  "memecoin.liveNew": "Under $10M · {floor}+ · newest first",
...
const id: Record<TKey, string> = {
  ...
  "memecoin.liveNew": "Di bawah $10J · {floor}+ · terbaru dulu",
  "memecoin.mcapShort": "MCAP",

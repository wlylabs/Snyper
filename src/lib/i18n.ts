...
const en = {
  ...
  "page.launchpad.title": "Launchpad",

  "balance.total": "Portfolio value",
  "balance.holdings": "Holdings",
  "balance.gas": "Gas",
  "balance.assets": "Assets",
  "balance.mask": "Cover these figures",
  "balance.unmask": "Show these figures",
  "balance.covered": "Covered",
  "balance.reread": "Read it again",
  "balance.unpriced": "{count} held with no price — not in this figure",
  ...
  "launchpad.viewNew": "New",
  "launchpad.viewTrending": "Trending",
  "launchpad.opened": "Under $10M · {floor}+ · newest first",
  "launchpad.live": "Under $10M · {floor}+ · coil ranked",
  "launchpad.mcapShort": "MCAP",
  "launchpad.gradeAll": "Any",
  "launchpad.dexscreener": "DEX Screener",
  "launchpad.snipe": "Snyper · buy {symbol}",
  "launchpad.noChart": "Not enough trades to draw yet.",
  "launchpad.gradeDeep": "Deep",
  "launchpad.bandAll": "All",
  "launchpad.bandCoil": "Coiling",
  "launchpad.bandPump": "Pumping",
  "launchpad.bandDump": "Dumping",
  "launchpad.showing": "{shown} of {total}",
  "launchpad.noMatch": "Nothing here matches that.",
  "launchpad.noMatchHint":
  ...
  "launchpad.clear": "Clear the filters",
  "launchpad.fresh": "NEW",
  "launchpad.pair": "Pair",
  "launchpad.mcap": "Market cap",
  "launchpad.fdv": "Fully diluted",
  "launchpad.volShort": "Vol",
  "launchpad.liqShort": "Liq",
  "launchpad.volume": "Volume",
  "launchpad.liquidity": "Liquidity",
  "launchpad.trades": "Trades",
  "launchpad.age": "Age",
  "launchpad.pool": "Pool fee",
  "launchpad.token": "Token",
  "launchpad.emptyNew": "Nothing has opened in the last day.",
  "launchpad.emptyNewHint":
    "Every pool opened on chain 4663 since yesterday is read here, and the deepest forty of them are priced. An empty screen means nothing opened — or that nothing which opened has anything resting in it yet. Trending is still reading the last five minutes.",
  "launchpad.empty": "Nothing has traded or opened recently.",
  "launchpad.emptyHint":
  ...
  "launchpad.failed": "The chain did not answer.",
  "launchpad.failedHint":
  ...
  "snipe.lock": "Liquidity lock",
  "snipe.lockAsking": "Reading who holds the liquidity under this pool.",
  "snipe.lockBurnedHint": "Every position was burned. Nobody holds a key to this pool.",
  "snipe.lockMixedHint": "The rest is held by wallets that can withdraw it at any block.",
  "snipe.lockOpenHint": "All of it is held by wallets that can withdraw it at any block.",
  "snipe.lockUnreadHint": "Contracts hold it, and none of them reads as a lock.",
  "snipe.lockEmptyHint": "Every position under this pool has been closed.",
  "snipe.lockFailed": "The positions under this pool could not be read.",
  "snipe.pullable": "This pool can be emptied",
  "snipe.pullableHint":
    "The exit check above runs the sale through this pool and answers for this block. It says nothing about the next one: the positions holding the liquidity are held by wallets with the keys to them, and they can be withdrawn at any time, including straight after a buy. That is what the pool allows, not a prediction about this token.",
  "snipe.outOfRange": "The burned liquidity is not under this price",
  "snipe.route": "Route",
...
const id: Record<TKey, string> = {
  ...
  "balance.gas": "Gas",
  "balance.assets": "Aset",
  "balance.mask": "Tutup angkanya",
  "balance.unmask": "Tampilkan angkanya",
  "balance.covered": "Ditutup",
  "balance.reread": "Baca ulang",
  "balance.unpriced": "{count} dipegang tanpa harga — tidak masuk angka ini",
  ...
  "launchpad.viewNew": "Baru",
  "launchpad.viewTrending": "Ramai",
  "launchpad.opened": "Di bawah $10J · {floor}+ · terbaru dulu",
  "launchpad.live": "Di bawah $10J · {floor}+ · urut coil",
  "launchpad.mcapShort": "MCAP",
  "launchpad.gradeAll": "Semua",
  "launchpad.dexscreener": "DEX Screener",
  "launchpad.snipe": "Snyper · beli {symbol}",
  "launchpad.noChart": "Belum cukup transaksi untuk digambar.",
  "launchpad.gradeDeep": "Dalam",
  "launchpad.bandAll": "Semua",
  "launchpad.bandCoil": "Coiling",
  "launchpad.bandPump": "Naik",
  "launchpad.bandDump": "Jatuh",
  "launchpad.showing": "{shown} dari {total}",
  "launchpad.noMatch": "Tidak ada yang cocok dengan itu.",
  "launchpad.noMatchHint":
  ...
  "launchpad.clear": "Bersihkan saringan",
  "launchpad.fresh": "BARU",
  "launchpad.pair": "Pair",
  "launchpad.mcap": "Kapitalisasi pasar",
  "launchpad.fdv": "Terdilusi penuh",
  "launchpad.volShort": "Vol",
  "launchpad.liqShort": "Lik",
  "launchpad.volume": "Volume",
  "launchpad.liquidity": "Likuiditas",
  "launchpad.trades": "Transaksi",
  "launchpad.age": "Umur",
  "launchpad.pool": "Biaya pool",
  "launchpad.token": "Token",
  "launchpad.emptyNew": "Belum ada pool yang dibuka sehari terakhir.",
  "launchpad.emptyNewHint":
    "Setiap pool yang dibuka di chain 4663 sejak kemarin dibaca di sini, dan empat puluh yang terdalam diberi harga. Layar kosong berarti memang tidak ada yang dibuka — atau yang dibuka belum ada isinya sama sekali. Ramai tetap membaca lima menit terakhir.",
  "launchpad.empty": "Belum ada yang jalan atau dibuka belakangan ini.",
  "launchpad.emptyHint":
  ...
  "launchpad.failed": "Chain tidak menjawab.",
  "launchpad.failedHint":
  ...
  "snipe.lock": "Kunci likuiditas",
  "snipe.lockAsking": "Membaca siapa yang memegang likuiditas di bawah pool ini.",
  "snipe.lockBurnedHint": "Semua posisi sudah dibakar. Tidak ada yang punya kuncinya.",
  "snipe.lockMixedHint": "Sisanya dipegang dompet yang bisa menariknya pada blok mana pun.",
  "snipe.lockOpenHint": "Semuanya dipegang dompet yang bisa menariknya pada blok mana pun.",
  "snipe.lockUnreadHint": "Yang memegang adalah kontrak, dan tidak satu pun terbaca sebagai kunci.",
  "snipe.lockEmptyHint": "Semua posisi di bawah pool ini sudah ditutup.",
  "snipe.lockFailed": "Posisi di bawah pool ini tidak bisa dibaca.",
  "snipe.pullable": "Pool ini bisa dikosongkan",
  "snipe.pullableHint":
    "Cek jalan keluar di atas menjalankan penjualan lewat pool ini dan menjawab untuk blok ini. Ia tidak mengatakan apa-apa soal blok berikutnya: posisi yang menahan likuiditasnya dipegang dompet yang punya kuncinya, dan bisa ditarik kapan saja — termasuk tepat setelah Anda beli. Itu yang diizinkan pool ini, bukan ramalan tentang token ini.",
  "snipe.outOfRange": "Likuiditas yang dibakar tidak menopang harga ini",
  "snipe.route": "Rute",

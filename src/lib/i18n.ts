...
const en = {
  ...
  "assets.dustHidden": "{count} holding(s) under $1 hidden",
  "assets.dustShown": "{count} holding(s) under $1",
...
const id: Record<TKey, string> = {
  ...
  "assets.marketCap": "MC",
  "assets.fdv": "FDV",
  "assets.dustHidden": "{count} kepemilikan di bawah $1 disembunyikan",
  "assets.dustShown": "{count} kepemilikan di bawah $1",
